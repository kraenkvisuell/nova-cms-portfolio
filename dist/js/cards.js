...
var render = function() {
  ...
  return _c("card", { staticClass: "flex flex-col h-20" }, [
    _c(
      "label",
      {
        staticClass: "block p-8 h-full text-center cursor-pointer",
        class: {
...
var render = function() {
  ...
  return _c("card", { staticClass: "flex flex-col flex flex-col h-20" }, [
    _c(
      "a",
      {
        staticClass: "block p-8 h-full text-center",
...
Nova.booting(function (Vue, router, store) {
  Vue.component('quick-works-card', __webpack_require__(/*! ./components/QuickWorksCard */ "./resources/js/components/QuickWorksCard.vue").default), Vue.component('slideshow-artist-card', __webpack_require__(/*! ./components/SlideshowArtistCard */ "./resources/js/components/SlideshowArtistCard.vue").default);
});
})();
